...
<form role="form" action="<?php echo e(URL::to('/save-blog')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card m-1 border border-primary mt-1">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12">
                        <a href="<?php echo e(URL::to('/add-blog')); ?>"><input type="button" class="btn btn-danger col-12 mt-2"
                                value="Hủy" /></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\website-online\resources\views/admin/add_blog.blade.php ENDPATH**/ ?>