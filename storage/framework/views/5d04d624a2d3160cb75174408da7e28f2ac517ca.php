            ...
            <div class="row">  	
                    <div class="col-sm-8">
                        <div class="contact-form">
                            ...
                            <form role="form" action="<?php echo e(URL::to('/save-contact-info')); ?>" method="POST" id="main-contact-form" class="contact-form row" name="contact-form">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\website-online\resources\views/pages/contact/contact.blade.php ENDPATH**/ ?>