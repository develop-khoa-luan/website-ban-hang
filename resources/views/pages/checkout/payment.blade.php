        ...
        <div>
                    ...
                    <div class="form-one" style="width:300px; margin: -10px 0 0 15px">
                        ...
                        <form  >
                            ...
                            <textarea name="shipping_email" style="margin: 0 0 5px 0" required="required" placeholder="Email*" rows="1"></textarea>
                            <textarea name="shipping_name" style="margin: 0 0 5px 0"  required="required" placeholder="Tên*" rows="1"></textarea>
                            <textarea name="shipping_address" style="margin: 0 0 5px 0"  required="required" placeholder="Địa chỉ*" rows="1"></textarea>
                            <textarea name="shipping_phone" style="margin: 0 0 5px 0"  required="required" placeholder="Số điện thoại*" rows="1"></textarea>
                    ...
                    <div style="margin: 300px 0 0 15px">
                        ...
                        @endif
                        <div>
                            <input type="submit" value="Đặt hàng" style="width: 80px; height: 30px; font-size: 14px;margin: 0" name="send_order_place" class="btn btn-primary btn-sm">
                            
                            <button style=" width: auto; height: 30px; font-size: 14px; margin: 20px 0 20px 20px; border: none; background-color: #FE980F" ><a style="color: white" href="{{URL::to('/trang-chu')}}">Tiếp tục mua sắm</a></button>
                                        ...
                                        <div class="chose_area" style="padding:10px 0 10px 10px">
                                            ...
                                            <form action="{{URL::to('/apply-coupon')}}" method="POST">
                                                ...
                                                <div style="">
                                                    ...
                                                    <input style="margin: -2px 0 0 0" type="submit" value="Áp dụng" class="btn btn-primary btn">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
