            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <tr style="text-align:center">
                        <td><img src="public/uploads/product/{{ $v_content->options->image}}" width="75" height="75">
                        </td>
            ...
            <div class="item active">
                ...
                <div class="col-sm-4">
                    <div class="product-image-wrapper">
                        <input name="product_id_hidden" id="product_id" type="hidden" value="{{$relate->product_id}}" />
                        <input name="qty" type="hidden" min="0" value="1" />
                        <a href="{{URL::to('/chi-tiet-san-pham/'.$relate->product_id)}}">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="height:250px" src="public/uploads/product/{{$relate->product_image}}"
                                        alt="" />
            ...
            $('.show-modal-product-detail').click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#modal-product-image").attr('src', 'public/uploads/product/' +
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        products_detail.forEach(element => {
                            var html = `<option class = "option-size" value="` +
                                element
